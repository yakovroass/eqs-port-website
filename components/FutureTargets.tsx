...
const phases = [
  {
    ...
    icon: <IconCrane className="w-8 h-8 sm:w-9 sm:h-9" stroke={1.5} aria-hidden />,
  },
  {
    ...
    icon: (
      <svg className="w-8 h-8 sm:w-9 sm:h-9" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} aria-hidden>
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex flex-row gap-4 sm:gap-5 items-start">
                        <div
                          className={`shrink-0 rounded-2xl bg-gradient-to-br ${phase.color} flex items-center justify-center text-white shadow-lg shadow-accent/10 w-14 h-14 sm:w-16 sm:h-16 ${i === 1 ? "motion-safe:animate-pulse" : ""}`}
                        >
                          {phase.icon}
                        </div>
