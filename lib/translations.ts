...
export const t = {
  ...
  market: {
    ...
    dataNote: {
      en: "ResearchAndMarkets / Globe Newswire · Grand View Research · Strategic Market Research",
      he: "ResearchAndMarkets / Globe Newswire · Grand View Research · Strategic Market Research",
    },
    tableRows: [
    ...
    /** מתחת למונה $432B — מתיישב עם שורת הסה\"כ בטבלה (לא \"שוק כולל\" גלובלי בטריליונים) */
    statDirectTotalLabel: { en: "Direct market potential", he: "פוטנציאל שוק ישיר" },
    statPotentialClientsLabel: { en: "Potential clients", he: "לקוחות פוטנציאליים" },
    statGrowthLabel: { en: "Growth by 2030", he: "צמיחה עד 2030" },
  ...
  invest: {
    ...
    fund1: {
      en: "Scale R&D, data science, and infrastructure",
      he: "הרחבת R&D מדעי נתונים ותשתיות",
    },
    fund2: {
      en: "Information security and intellectual property registration",
