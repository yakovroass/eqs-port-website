...
function DownloadRow({ className = "" }: { className?: string }) {
  ...
  const btn =
    "flex flex-1 min-w-0 items-center justify-center gap-0.5 sm:gap-2 py-2.5 px-0.5 sm:px-3 rounded-xl font-semibold whitespace-nowrap text-[10px] min-[400px]:text-[11px] sm:text-sm leading-tight transition-colors border border-accent/30 text-accent hover:bg-accent/10";
            ...
            <div className="flex flex-col gap-4">
              <div className="glass-card rounded-2xl p-6 sm:p-8">
                ...
                <a
                  ...
                  className="mt-6 w-full flex items-center justify-center gap-2 py-3.5 px-4 rounded-xl font-semibold bg-accent/15 border border-accent/40 text-accent hover:bg-accent/25 hover:text-white transition-colors"
                >
